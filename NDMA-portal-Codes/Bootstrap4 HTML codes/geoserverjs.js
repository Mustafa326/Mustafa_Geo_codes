...
var geoserver = L.tileLayer.wms(`https://view.eumetsat.int/geoserver/ows?service=WMS&request=GetMap&version=1.3.0&layers=msg_fes:rgb_airmass&styles=&format=image/jpeg&crs=EPSG:4326&bbox=-77,-77,77,77&width=800&height=800&time=2021-06-18T08:15:00.000Z`, {
});
//var wmsLayer2 = L.tileLayer.wms('http://ows.mundialis.de/services/service?', {
 //   layers: 'TOPO-OSM-WMS'
//}).addTo(map);
var wmsLayer = L.tileLayer.wms('https://view.eumetsat.int/geoserver/ows', {
   layers: 'msg_iodc:rgb_fog',
   format: 'image/png',
  transparent: true
})//.addTo(map);
//var geoserver=new L.TileLayer.WMS("http://localhost:8080/geoserver/Eumetsat/wms",{layers:'rgb_fog',format: 'image/geotiff'})//,transparent: true})
...
var geoimage=L.layerGroup([wmsLayer])
//geoimage.addTo(map)
