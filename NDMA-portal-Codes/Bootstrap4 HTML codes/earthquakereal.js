...
// Function to create a realtime earthquake layer
...
info.addTo(map);
// Listen for 'overlayadd' event on the layer control
map.on('overlayadd', function (eventLayer) {
    // Check if the added layer is a realtime earthquake layer
    if (eventLayer.layer instanceof L.Realtime) {
        // Start fetching and adding the realtime earthquake data to the map
        eventLayer.layer.addTo(map);
    }
});

// Listen for 'overlayremove' event on the layer control
map.on('overlayremove', function (eventLayer) {
    // Check if the removed layer is a realtime earthquake layer
    if (eventLayer.layer instanceof L.Realtime) {
        // Stop fetching and remove the realtime earthquake data from the map
