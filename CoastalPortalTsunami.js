...
map.on('idle', async() => {
    const toggleableLayerIds = ['mindusdelta', 'mjiwani', 'msandspit', 'mkalmatkhor', 'msonmianikhor','tsunamrisk','tcyclonepopulation','tcyclonemortality']; // IDs of layers with checkboxes and sliders
